      ...
      <div className="container media__container">
        ...
        <div className={`${style.block_content}`}>
          <span className={`${style.section_right} `}>
            <div className={`${style_page.contents} ${style.news_item}`}>
              <div>
                ...
                <div className={style_article.grid_2}>
                  <span className={style.news_item__img}>
                    <img src={localState.page_news[1].img} alt="NoN" />
                  </span>
                  <span className={style_page.news_item__info}>
                    <div>
                      <div className={style_page.data}>
                        ...
                        <p>{localState.page_news[1].date}</p>
                      </div>
                      ...
                      <span className={style_article.text_info}>
                        <p>
                          ...
                          названием Starbase с тикером STAR. На официальном
                          сайте проекта написано, что он представляет собой
                          «платформу краудфандинга на основе блокчейна». По
                          сути, это место, где стартапы могут собирать средства
                          путём выпуска токенов. По данным DEXTools, нативный
                          токен проекта, который в начале мая торговался
                          примерно по $0,002, сегодня достиг $ 0,30. С
                          сегодняшнего минимума до сегодняшнего максимума цена
                          выросла в общей сложности на 6000%. Для тех, кто не
                          знает, стартовая база SpaceX, расположенная в деревне
                          Бока-Чика округа Камерон в штате Техас, не имеет
                          ничего общего с токеном Starbase. Действительно, Илон
                          Маск всё больше напоминает пребывающего в тюрьме Джона
                          Макафи, который брался рекламировать любые токены, в
                          том числе откровенно мошеннические. Правда, делал он
                          это в более очевидной форме. Как мы знаем, бурная и
                          безответственная активность Макафи в Твиттере
                          привлекла к нему внимание Налоговой службы, которая
                          впоследствии наложила на него штраф за отсутствие
                          информации о коммерческой подоплёке публикации. Также
                          Макафи обвиняют в уклонении от налогов, что является
                          довольно серьёзным преступлением в США, за которое ему
                          грозит уголовная ответственность. Команда, выпустившая
                          токен, поблагодарила Маска за его как бы неожиданно
                          появившееся фото, которое обеспечило космический рост
                          ничем не примечательного криптоактива. В дальнейшем с
                          сегодняшнего максимума цена токена снизилась более чем
                          на 80%, что показывает, насколько рискованно покупать
                          альткоины с сомнительной ценностью и слепо верить во
                          всё, что публикует продуманный миллиардер.
                        </p>
                      </span>
                    </div>
                  </span>
