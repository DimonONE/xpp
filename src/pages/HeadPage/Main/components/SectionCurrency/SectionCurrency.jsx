        ...
        <section id="currency" className="section currency">
            <div className="container currency__container">
                ...
                <div className="col-lg-6 currency__accordions">
                    <Fade direction="left" delay={0.6} triggerOnce="true">
                        <div className="currency__accordion-wrap wow animate__animated animate__fadeInLeft">                    
                    ...
                    <Fade direction="left" delay={0.4} triggerOnce="true">
                        <div className="currency__accordion-wrap wow animate__animated animate__fadeInLeft">
