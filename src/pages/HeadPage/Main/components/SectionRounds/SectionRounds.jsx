...
export const SectionRounds = (props) => {
    return(
        ...
        <div
          className="container rounds__container wow animate__animated animate__fadeIn"
        >
            ...
            <div className="col-lg-6 col-xl-6 rounds__info">
              <div className="rounds__info-item">
                ...
                <div className="rounds__info-item-progress">
                  <div
                    className="rounds__info-item-progress-line wow animate__animated widthFrom0to100"
                    style={{width: '100%'}}
                  ></div>
                </div>
              ...
              <div className="rounds__info-item">
                <div className="d-flex rounds__info-item-header">
                  ...
                  <div className="rounds__info-item-price">1$ * 1 250 000 XXP</div>
                </div>
                <div className="rounds__info-item-progress">
                  <div
