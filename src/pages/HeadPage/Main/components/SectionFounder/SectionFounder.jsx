        ...
        <section className="section founder">
            ...
            <div className="row founder__row">
                ...
                <img
                    src={founder__img}
                    alt="Img"
                    className="img-responsive founder__img wow animate__animated animate__fadeInLeft"
                />
                <div
                    className="founder__info-wrap wow animate__animated animate__fadeInUp"
                >
                    ...
                    <div className="founder__info-text">
                        ...
                        Professional trader, financial analyst. <br />
                ...
                <div
                className="col-lg-7 founder__texts wow animate__animated animate__fadeInRight"
                >
                <h2
                ...
                <div className="founder__text">
                    Trading and investments are trending today. Thousands of stocks
                    of various companies are represented on hundreds of markets...
                    it is difficult to process such a volume of information even for
                    professionals, and it is almost impossible for beginning traders
                    or investors. Moreover, such activities take a lot of time and
                    effort, and the results often leave much to be desired...
                </div>
                <div className="founder__text">
