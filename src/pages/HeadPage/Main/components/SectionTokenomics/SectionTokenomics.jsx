    ...
    return(
      <section id="tokenomics" className="section tokenomics">
        <div className="container tokenomics__container">
          ...
          <h2
            className="heading tokenomics__heading font-size-40 wow animate__animated animate__fadeInLeft"
          >
            <b className="font-weight-700">Tokenomics</b>
          </h2>
          <div className="row tokenomics__row">
            <div
              className="col-lg-6 tokenomics__list-wrap wow animate__animated animate__fadeInLeft"
            >
              <div className="tokenomics__list">
                <div className="tokenomics__list-item active">
                ...
                <div className="tokenomics__list-item hidden">
                  ...
                  <div className="tokenomics__list-text">
                    <b className="font-weight-700">500,000 XXP</b> tokens — fund for
                    holding promotions, bounty campaigns, contests, quizzes and
                    other events
                  </div>
                </div>
              </div>
            ...
            <div
              className="tokenomics__charts col-lg-6 wow animate__animated animate__fadeInRight"
            >
              ...
              <div className="tokenomics__chart-info-wrap">
                <div className={`tokenomics__chart-info-icon ${style.tokenomics__chart_info_icon}`}></div>
